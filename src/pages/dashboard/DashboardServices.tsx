      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              {services.length} من {limits.services} خدمة
            </p>
          </div>
          <Button
            onClick={() => {
        ...
        {!canAddMore && (
          <Alert>
            ...
            <AlertDescription>
              لقد وصلت للحد الأقصى من الخدمات في خطتك الحالية. قم بالترقية لإضافة المزيد.
            </AlertDescription>
          </Alert>
        )}
        ...
        <DialogContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit">
                {selectedService ? 'حفظ التغييرات' : 'إضافة'}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              هل أنت متأكد من حذف خدمة "{selectedService?.title}"؟
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
