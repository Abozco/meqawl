...
const defaultPlans = [
  {
    ...
    defaultPrice: "50",
    period: "د.ل / شهرياً",
    features: ["صفحة عامة لشركتك", "حتى 7 مشاريع", "حتى 7 خدمات", "إدارة الفريق", "دعم فني"],
    popular: false,
  },
  {
    name: "احترافي",
    ...
    defaultPrice: "100",
    period: "د.ل / شهرياً",
    features: ["كل مميزات الأساسي", "حتى 15 مشروع", "حتى 15 خدمة", "إحصائيات متقدمة", "توثيق الشركة", "أولوية الدعم الفني"],
    popular: true,
  },
  {
    name: "متقدم",
    ...
    defaultPrice: "200",
    period: "د.ل / شهرياً",
    features: ["كل مميزات الاحترافي", "حتى 25 مشروع", "حتى 25 خدمة", "تقارير مفصلة", "دعم مخصص", "توثيق تلقائي بالعلامة الزرقاء"],
    popular: false,
  },
];
